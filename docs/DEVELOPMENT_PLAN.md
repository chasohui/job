...
|---|---|---|---|:---:|
| **REQ-01** | 전공, 희망 직무, 준비 상황(여러 줄) 입력 | `input-step.tsx`, `field.tsx` | Sprint 1 | 완료 |
| **REQ-02** | 글자 수 검증 (전공/직무 2~50자, 준비상황 10~1,000자) | `validation.ts` | Sprint 1 | 완료 |
...
| **5.2** | 최소 글자 수 미달 | `전공과 희망 직무는 2자 이상, 준비 상황은 10자 이상 입력해주세요.` | 실시간 안내, 입력값 유지 |
